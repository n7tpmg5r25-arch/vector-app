  ...
  return (
    <>
      ...
      <main style={{
        ...
        <P>
          The Washington State Legislature's public record is the authoritative source for any bill referenced in Vector | WA. Where Vector | WA and the Legislature's record disagree, the Legislature's record controls. Corrections and questions: colin@shorepinegr.com.
        </P>
      </main>
    </>
  )
